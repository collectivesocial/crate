  ...
  SocialCrateRssFeed: {
    ...
    defs: {
      main: {
        type: 'record',
        description:
          'An RSS or Atom feed the author follows or publishes. Minimum viable shape: a URL plus a display title. Optional fields support importer pipelines (destination NSID, poller bookkeeping) but are not required — most consumers just want the link to render on a personal site.',
        key: 'tid',
        record: {
          type: 'object',
          ...
          properties: {
            ...
            title: {
              ...
              maxGraphemes: 200,
              maxLength: 2000,
              description: 'Human-readable display name for this feed.',
            },
            description: {
              type: 'string',
              maxGraphemes: 2000,
            ...
            createdAt: {
              type: 'string',
              format: 'datetime',
              description: 'Timestamp when this feed record was created.',
            },
          },
        },
      },
